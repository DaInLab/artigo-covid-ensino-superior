...
if (get_os() == "windows")
  dbf.csv <-read.csv("D:/GitHub/artigo-covid-ensino-superior/dados/COVID19IES.csv", header = TRUE, sep = ";", quote = "\"", dec = ".")
if (get_os() == "osx") dbf.csv <-read.csv("/Volumes/Extension/GitHub/artigo-covid-ensino-superior/dados/COVID19IES.csv", header = TRUE, sep = ";", quote = "\"", dec = ".")
```
