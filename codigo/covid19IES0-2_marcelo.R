...
ggplot(df_idade, aes(x=Var1, y=Freq))+
  geom_col(width=.6, fill=rainbow(10), col='black')+
  geom_text(aes(label=Freq),nudge_y=0.5)+
  labs(x='', y='Qtde.Respondentes')+
  ggtitle('Gráfico 1: Quantidade dos Respondentes por Faixa etária')+
  theme_minimal()+
  coord_flip()
...
df_genero[1,1] <- 'Nao Respondeu'

df_genero

ggplot(df_genero, aes(x=genero, y=n))+
  geom_col(width=.6, fill=rainbow(4), col='black')+
  geom_text(aes(label=paste(n,' (', perc, '%)')),nudge_y=3.5)+
  labs(x='', y='Qtde.Respondentes', title='Gráfico 2: Quantidade de respondentes por gênero')+
  theme_minimal()
...
ggplot(df_conjugal, aes(x=situacao_conjugal, y=n))+
  geom_col(width=.6, fill=alpha('blue',3), col='black')+
  geom_text(aes(label=paste(n,' (', perc, '%)')),nudge_y=3.5, size = 2.5)+
  labs(x='', y='Qtde.Respondentes')+
  ggtitle('Gráfico 3: Quantidade de respondentes por situação conjugal')+
  theme_minimal()+
  coord_flip()
...
ggplot(df_emprego, aes(x=situacao_empregaticia, y=n))+
  geom_col(width=.6, fill=alpha('orange',3), col='black')+
  geom_text(aes(label=paste(n,' (', perc, '%)')),nudge_y=2.5, size = 2.7)+
  labs(x='Situação Empregatícia', y='Qtde.Respondentes')+
  ggtitle('Gráfico 4: Quantidade de respondentes por situação empregatícia')+
  theme_minimal()+
  coord_flip()
...
ggplot(df_tipo_ies, aes(x=tipo_ies, y=perc))+
  geom_col(width=.6, fill=alpha('gray',3), col='black')+
  geom_text(aes(label=paste(n,' (', perc, '%)')),nudge_y=6)+
  labs(x='', y='Qtde.Respondentes')+
  ggtitle('Gráfico 5: Quantidade de respondentes por Tipo Instituição de Ensino')+
  theme_minimal()
...
ggplot(df_vacina, aes(x=vacinado, y=perc))+
  ...
  labs(x='', y='Qtde. Respondentes')+
  ggtitle('Gráfico 8: Vacinados Covid-19')+
  theme_minimal()
...
ggplot(df_nivel_ensino, aes(x=nivel_ensino, y=n))+
  ...
  labs(x='Situação Vacina', y='Qtde.Respondentes')+
  ggtitle('Gráfico 9: Quantidade de respondentes por Nível Ensino')+
  theme_minimal()+
  coord_flip()
...
df_local_estudante[1] <- c("Não Respondeu",
                           "Cidade da IES", 
                           "Outra cidade")

df_local_estudante

ggplot(df_local_estudante, aes(x=local_estudante, y=n))+
  geom_col(width=.6, fill=alpha('green',3), col='black')+
  geom_text(aes(label=paste(n, ' (', perc, '%)')),nudge_y=6)+
  labs(x='', y='Qtde.Respondentes')+
  ggtitle('Gráfico 10: Quantidade de respondentes por Procedência Aluno')+
  theme_minimal()
...
df_morando_com[1,1] <- 'Não Respondeu'

df_morando_com

ggplot(df_morando_com, aes(x=morando_com, y=perc))+
  geom_col(width=.6, fill=alpha('darkorange',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=6)+
  labs(x='', y='%')+
  ggtitle('Gráfico 11: Aluno mora com quem?')+
  theme_minimal()
...
df_decisao_fechar[1,1] <- 'Não Respondeu'

df_decisao_fechar

ggplot(df_decisao_fechar, aes(x=decisao_fechar, y=perc))+
  geom_col(width=.6, fill=alpha('red',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=6)+
  labs(x='', y='%')+
  ggtitle('Gráfico 12: Decisão de fechar IES e utilizar ferramentas online')+
  theme_minimal()
...
df_migrou_virtual[1,1] <- 'Não Respondeu'

df_migrou_virtual

ggplot(df_migrou_virtual, aes(x=migrou_virtual, y=perc))+
  geom_col(width=.6, fill=alpha('brown',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=6)+
  labs(x='', y='%')+
  ggtitle('Gráfico 13: IES Migrou para Ambiente Virtual')+
  theme_minimal()
...
ggplot(df_acesso_infra_ies, aes(x=acesso_infra_ies, y=perc))+
  geom_col(width=.6, fill=alpha('brown',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=6)+
  labs(x='', y='%')+
  ggtitle('Gráfico 14: Acesso à infra-estrutura da IES')+
  theme_minimal()
...
ggplot(df_acesso_professores, aes(x=acesso_professores, y=perc))+
  geom_col(width=.6, fill=alpha('lightblue',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=6)+
  labs(x='', y='%')+
  ggtitle('Gráfico 15: Acesso aos Professores durante a pandemia')+
  theme_minimal()
...
ggplot(df_aulas_durante_pandemia, aes(x=aulas_durante_pandemia, y=perc))+
  geom_col(width=.6, fill=alpha('pink',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=6)+
  labs(x='', y='%')+
  ggtitle('Gráfico 16: Modo de lecionar durante a pandemia')+
  theme_minimal()
...
df_ies_reinicio[1] <- c('Não Respondeu',
                        'Parcialmente',
                        'Não SAbe',
                        'Não Retornou',
                        'Retornou Totalmente')
...
ggplot(df_ies_reinicio, aes(x=ies_reinicio, y=perc))+
  geom_col(width=.6, fill=alpha('blue',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=6)+
  labs(x='', y='%')+
  ggtitle('Gráfico 17: IES reiniciou atividades presenciais')+
  theme_minimal()
...
ggplot(df_acesso_internet, aes(x=acesso_internet, y=perc))+
  geom_col(width=.6, fill=alpha('orange',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=6)+
  labs(x='', y='%')+
  ggtitle('Gráfico 18: Acesso aos serviços de internet')+
  theme_minimal()
...
ggplot(df_desempenho_escolar, aes(x=desempenho_escolar, y=perc))+
  geom_col(width=.6, fill=alpha('lightgray',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=2)+
  labs(x='', y='%')+
  ggtitle('Gráfico 19: Desempenho escolar na pandemia')+
  theme_minimal()
...
ggplot(df_vivenciou, aes(x=vivenciou, y=perc))+
  geom_col(width=.6, fill=alpha('red',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=2)+
  labs(x='', y='%')+
  ggtitle('Gráfico 20: Dificuldades vividas pelo aluno')+
  theme_minimal()+
  coord_flip()
...
ggplot(df_despesas, aes(x=despesas, y=perc))+
  geom_col(width=.6, fill=alpha('darkred',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=2)+
  labs(x='', y='%s')+
  ggtitle('Gráfico 21: Despesas durante a pandemia')+
  theme_minimal()+
  coord_flip()
...
df_renda_financeira[1] <- c('Não Respondeu',
                    'Aumentou',
                    'Diminuiu',
                    'Não Mudou',
                    'Não quer responder')
...
ggplot(df_renda_financeira, aes(x=renda_financeira, y=perc))+
  geom_col(width=.6, fill=alpha('yellow',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=2)+
  labs(x='', y='% Respondentes')+
  ggtitle('Gráfico 22: Renda Financeira durante a pandemia')+
  theme_minimal()+
  coord_flip()
...
df_ajuda_financeira[1,1] <- 'Não Respondeu'

df_ajuda_financeira

ggplot(df_ajuda_financeira, aes(x=ajuda_financeira, y=perc))+
  geom_col(width=.6, fill=alpha('purple',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=4)+
  labs(x='', y='%')+
  ggtitle('Gráfico 23: Recebeu auxílio financeiro da IES durante a pandemia')+
  theme_minimal()+
  coord_flip()
...
df_nivel_endividamento[1] <- c('Não Respondeu',
                              'Aumentou',
                              'Diminuiu',
                              'Não Mudou',
                              'Não sabe')
...
ggplot(df_nivel_endividamento, aes(x=nivel_endividamento, y=perc))+
  geom_col(width=.6, fill=alpha('purple',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=4)+
  labs(x='', y='%')+
  ggtitle('Gráfico 24: Endividamento durante pandemia')+
  theme_minimal()+
  coord_flip()
...
df_despesas_cresceram <- data.frame(despesas= c("Relacionadas a saúde", 
                                                "Deslocamento", 
                                                "Transporte urbano", 
                                                "Aluguel", 
                                                "Internet", 
...
ggplot(df_despesas_cresceram, aes(x=despesas, y=perc))+
  geom_col(width=.6, fill=alpha('red',3), col='black')+
  geom_text(aes(label=paste(perc,"%")),nudge_y=1.4)+
  labs(x='', y='% Despesas')+
  ggtitle('Gráfico 25: Despesas que cresceram durante pandemia')+
  theme_minimal()+
  coord_flip()
